function [obj, varargout] = mtcell(varargin)
%@mtcell Constructor function for mtcell class
%   OBJ = mtcell(varargin)
%
%   OBJ = mtcell('auto') attempts to create a mtcell object by ...
%   
%   %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   % Instructions on mtcell %
%   %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
%example [as, Args] = mtcell('save','redo')
%
%dependencies: 

Args = struct('RedoLevels',0, 'SaveLevels',0, 'Auto',0, 'ArgsOnly',0, ...
				'ObjectLevel','Cell','RequiredFile','spiketimes.mat', ...
				'BinSize',100, 'ThresVel',0, 'NumShuffles',10000, 'ShuffleLimits',[0.1 0.9], ...
                'AdaptiveSmooth',1);
...
Args.classname = 'mtcell';
Args.matname = [Args.classname '.mat'];
Args.matvarname = 'mtcell';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for alpha_no = 1:size(alpha_values,2)
        ...
        for sp = 1:size(flat_spiketimes,1)
            ...
            if repeat == 1
                tbin_hit = stc(interval,2);
                tbin_hit = tbin_hit(logical(conditions(interval)));
                tbin_hit(~(tbin_hit>0)) = [];
...
%                     end
                ...
                if repeat == 1
                    ...
                    data.binSpikeCount = binSpikeCount;
                    data.binDuration = binDuration;
                    data.binFiringRate = binSpikeCount./binDuration;
